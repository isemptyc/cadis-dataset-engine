...
DEFAULT_WORK_DIR = Path.home() / ".cache" / "cadis_dataset_engine" / "venezuela"

VE_PROFILE = AdminProfile(
...
class VenezuelaAdminEngine(BrazilAdminEngine):
    ENGINE = "ve_admin"
    VERSION = "v1.0"
    ...
    def __init__(
        ...
        *,
        ...
        self._admin_dataset_path = self._work_dir / "venezuela_admin.json"
        self._ffsf_dataset_path = self._work_dir / "venezuela_admin.bin"
        self._ffsf_meta_path = self._work_dir / "VE_feature_meta_by_index.json"
        self._semantic_dataset_path = self._work_dir / "venezuela_admin_semantic.json"
        ...
        if osm_pbf_path is None:
            raise ValueError(
                "VenezuelaAdminEngine in cadis-dataset-engine is build-only. "
    ...
    def _ensure_datasets(self, osm_pbf_path: str) -> None:
        ...
        if not self._semantic_dataset_path.exists():
            ...
            export_admin_semantic_dataset(
                ...
                version="ve-admin-semantic-1.0.0",
