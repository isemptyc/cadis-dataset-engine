...
class ChinaAdminEngine(BrazilAdminEngine):
    ...
    def _runtime_policy_payload(self) -> dict:
        ...
        return {
            ...
            "shape_status": [{"levels": shape, "status": "ok" if 4 in shape or 5 in shape else "partial"} for shape in allowed_shapes],
            ...
            "hierarchy_repair_rules": {
                ...
                "sub_engine_anchors": [{"source": "tibet", "parent_level": 5}],
            },
