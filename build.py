...
from engines.gl.engine_gl import GreenlandAdminEngine
from engines.by.engine_by import BelarusAdminEngine
from engines.mo.engine_mo import MacauAdminEngine
from engines.hk.engine_hk import HongKongAdminEngine
from engines.cn.engine_cn import ChinaAdminEngine
from engines.zw.engine_zw import ZimbabweAdminEngine
from engines.zm.engine_zm import ZambiaAdminEngine
from engines.ug.engine_ug import UgandaAdminEngine
from engines.tn.engine_tn import TunisiaAdminEngine
from engines.tg.engine_tg import TogoAdminEngine
from engines.tz.engine_tz import TanzaniaAdminEngine
from engines.sz.engine_sz import EswatiniAdminEngine
from engines.sd.engine_sd import SudanAdminEngine
from engines.ss.engine_ss import SouthSudanAdminEngine
from engines.za.engine_za import SouthAfricaAdminEngine
from engines.so.engine_so import SomaliaAdminEngine
from engines.sl.engine_sl import SierraLeoneAdminEngine
from engines.sc.engine_sc import SeychellesAdminEngine
from engines.gm.engine_gm import GambiaAdminEngine
from engines.sn.engine_sn import SenegalAdminEngine
from engines.st.engine_st import SaoTomeandPrincipeAdminEngine
from engines.sh.engine_sh import SaintHelenaAscensionandTristandaCunhaAdminEngine
from engines.rw.engine_rw import RwandaAdminEngine
from engines.ng.engine_ng import NigeriaAdminEngine
...
from engines.mu.engine_mu import MauritiusAdminEngine
from engines.mr.engine_mr import MauritaniaAdminEngine
from engines.ml.engine_ml import MaliAdminEngine
from engines.mw.engine_mw import MalawiAdminEngine
from engines.mg.engine_mg import MadagascarAdminEngine
from engines.ly.engine_ly import LibyaAdminEngine
from engines.lr.engine_lr import LiberiaAdminEngine
from engines.ls.engine_ls import LesothoAdminEngine
...
from engines.gh.engine_gh import GhanaAdminEngine
from engines.ga.engine_ga import GabonAdminEngine
from engines.et.engine_et import EthiopiaAdminEngine
from engines.er.engine_er import EritreaAdminEngine
from engines.gq.engine_gq import EquatorialGuineaAdminEngine
from engines.eg.engine_eg import EgyptAdminEngine
from engines.dj.engine_dj import DjiboutiAdminEngine
from engines.cd.engine_cd import DemocraticRepublicoftheCongoAdminEngine
from engines.cg.engine_cg import CongoAdminEngine
from engines.km.engine_km import ComorosAdminEngine
...
from engines.ru.engine_ru import RussiaAdminEngine
...
def main() -> int:
    ...
    if country == "ru":
        RussiaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "km":
        ComorosAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "cg":
        CongoAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "cd":
        DemocraticRepublicoftheCongoAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "dj":
        DjiboutiAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "eg":
        EgyptAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "gq":
        EquatorialGuineaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "er":
        EritreaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "et":
        EthiopiaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "ga":
        GabonAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "gh":
        GhanaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "gn":
        GuineaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "gw":
        GuineaBissauAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "ls":
        LesothoAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "lr":
        LiberiaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "ly":
        LibyaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "mg":
        MadagascarAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "mw":
        MalawiAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "ml":
        MaliAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "mr":
        MauritaniaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "mu":
        MauritiusAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "ma":
        MoroccoAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "mz":
        MozambiqueAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "ng":
        NigeriaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "rw":
        RwandaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "sh":
        SaintHelenaAscensionandTristandaCunhaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "st":
        SaoTomeandPrincipeAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "sn":
        SenegalAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "gm":
        GambiaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "sc":
        SeychellesAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "sl":
        SierraLeoneAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "so":
        SomaliaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "za":
        SouthAfricaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "ss":
        SouthSudanAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "sd":
        SudanAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "sz":
        EswatiniAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "tz":
        TanzaniaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "tg":
        TogoAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "tn":
        TunisiaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "ug":
        UgandaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "zm":
        ZambiaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "zw":
        ZimbabweAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "cn":
        ChinaAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "hk":
        HongKongAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "mo":
        MacauAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "by":
        BelarusAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
    ...
    if country == "gl":
        GreenlandAdminEngine.prepare_datasets(
            osm_pbf_path=args.osm,
            work_dir=work_dir,
            country_geometry_path=args.country_geometry,
        )
